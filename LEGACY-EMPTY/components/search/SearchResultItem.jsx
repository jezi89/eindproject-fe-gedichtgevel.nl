...
const SearchResultItem = memo(({
    ...
    // Helper to navigate to recording page (Spreekgevel) with complete poem data
    const navigateToRecording = useCallback(async () => {
        if (!poem) return;
        try {
            // Save complete poem data to SearchContext for retrieval on recording page
            await searchContextService.saveSelectedPoem(poem);
            console.log('🎤 Navigating to Spreekgevel with poem:', poem);

            // Navigate to recording page
            navigate('/spreekgevel');
        } catch (error) {
            console.error('Failed to save poem for recording:', error);
