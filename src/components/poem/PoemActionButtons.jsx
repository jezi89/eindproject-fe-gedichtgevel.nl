      ...
      >
        ...
        {onNavigateToRecording && (
          ...
          >
            ...
            {showLabels && (
              <span className={styles.buttonText}>Declameer in Recorder</span>
            )}
          </motion.button>
        )}
          ...
          <>
            {canvasMode ? (
              ...
              >
                <span className={styles.expandIcon}>📋</span>
                {showLabels && (
                  <span className={styles.buttonText}>Laad in canvas</span>
                )}
              </motion.button>
            ) : (
              <motion.button
              ...
              >
                <span className={styles.expandIcon}>🎨</span>
                {showLabels && (
                  <span className={styles.buttonText}>Open in canvas</span>
                )}
              </motion.button>
            )}
          </>
