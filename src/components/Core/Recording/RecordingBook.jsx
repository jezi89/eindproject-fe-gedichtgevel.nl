            ...
            <div className={layoutStyles.SpreekgevelApp}>
              <div className={layoutStyles.MainContent}>
                ...
                <div className={componentStyles.BookContainer}>
                      ...
                      <div className={componentStyles.OverlayHeader}>
                        ...
                        >
                          ...
                          <span style={{ fontSize: "0.9rem", color: "#666" }}>
                            {results.length}{" "}
                            {results.length === 1 ? "gedicht" : "gedichten"}{" "}
                            gevonden
                          </span>
                        </div>
                        <button
                  ...
                  <div
                    className={`${componentStyles.PagePanel} ${componentStyles.RecordingPanel}`}
                  >
                    {/* Container for mic selection dropdown */}
                    <div
                      className={componentStyles.micSelectWrapper}
                      onClick={controlsState.requestMicPermission}
                    >
                      ...
                      {controlsState.micDevices.length > 0 ? (
                        <select
                          ...
                          onChange={(e) =>
                            controlsState.handleSelectMic(e.target.value)
                          }
                          disabled={
                            controlsState.isRecording ||
                            controlsState.isCountdownActive
                          }
                          title={
                            controlsState.isRecording
                              ? "Kan niet wisselen tijdens opname"
                              : "Kies een microfoon"
                          }
                        >
                        ...
                        <span className={componentStyles.micPlaceholder}>
                          <strong
                            className={componentStyles.micPlaceholderClick}
                          >
                            Klik hier
                          </strong>{" "}
                          om microfoons te laden...
                        </span>
                      )}
                    ...
                    <div className={componentStyles.waveformWrapper}>
                      <div
                        ref={waveformRef}
                        className={componentStyles.waveform}
                      ></div>
                      <div
                        ref={timelineRef}
                        className={componentStyles.timelineContainer}
                      ></div>
                    </div>
                    ...
                    <div className={componentStyles.SaveButtonSection}>
                      <button
                        ...
                        title={
                          controlsState.recordedAudioBlob
                            ? "Sla opname op in browser"
                  ...
                  <div
                    className={`${componentStyles.PagePanel} ${componentStyles.PoemPanel}`}
                  >
                    {activeTab === "Beluister Opnames" ? (
                            ...
                            {storage.recordings.map((rec) => (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <button
                                    onClick={() =>
                                      storage.deleteRecording(rec.id)
                                    }
                                    style={{
                                      background: "red",
                                      color: "white",
                      ...
                      <>
                        ...
                        <div
                          className={componentStyles.PoemPanel_content}
                          ref={poemContentRef}
                        >
                          {memoizedPoemLines}
                        </div>
                        <div className={componentStyles.BottomButtonWrapper}>
                          <button
                            className={componentStyles.BrowseButton}
                            onClick={handleComingSoon}
                          >
                            <span>Klik voor text highlight</span>
                            <HighlightIcon
                              className={componentStyles.ButtonIcon}
                            />
                          </button>
                          ...
                          <div className={componentStyles.AutoScrollContainer}>
                            ...
                            <div className={componentStyles.SpeedControl}>
                              <span className={componentStyles.SpeedLabel}>
                                Snelheid:
                              </span>
                              <div className={componentStyles.SpeedButtons}>
                                {[1, 2, 3, 4, 5].map((speed) => (
                                  <button
                                    key={speed}
                                    className={`${componentStyles.SpeedBtn} ${
                                      scrollSpeed === speed
                            ...
                            <button
                              ...
                              style={{
                                backgroundColor: isAutoScrollArmed
                                  ? "#e6b85c"
                                  : undefined,
                                borderColor: isAutoScrollArmed
                                  ? "#c29a4b"
                                  : undefined,
                              }}
