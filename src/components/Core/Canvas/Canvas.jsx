...
export default function Canvas({
                                 ...
                                 const currentPoem = poemData || {
                                   ...
                                   lines: [
                                     "Selecteer een gedicht om te visualiseren",
                                   ],
                                 };
                                 ...
                                 const isMobile = layout.windowWidth <= 768;
                                 ...
                                 useEffect(() => {
                                   if (savedCanvasState) {
                                     ...
                                     setTimeout(() => {
                                       ...
                                       if (
                                         savedCanvasState.backgroundImage !==
                                         undefined
                                       ) {
                                       ...
                                       if (savedCanvasState.poemOffset)
                                         canvasState.setPoemOffset(
                                           savedCanvasState.poemOffset
                                         );
                                       if (savedCanvasState.fontSize)
                                         canvasState.setFontSize(
                                           savedCanvasState.fontSize
                                         );
                                       if (savedCanvasState.fillColor)
                                         canvasState.setFillColor(
                                           savedCanvasState.fillColor
                                         );
                                       if (
                                         savedCanvasState.letterSpacing !==
                                         undefined
                                       )
                                         canvasState.setLetterSpacing(
                                           savedCanvasState.letterSpacing
                                         );
                                       if (savedCanvasState.lineHeight)
                                         canvasState.setLineHeight(
                                           savedCanvasState.lineHeight
                                         );
                                       if (
                                         savedCanvasState.lineHeightMultiplier
                                       )
                                         canvasState.setLineHeightMultiplier(
                                           savedCanvasState.lineHeightMultiplier
                                         );
                                       if (savedCanvasState.textAlign)
                                         canvasState.setTextAlign(
                                           savedCanvasState.textAlign
                                         );
                                       if (savedCanvasState.fontWeight)
                                         canvasState.setFontWeight(
                                           savedCanvasState.fontWeight
                                         );
                                       if (savedCanvasState.fontStyle)
                                         canvasState.setFontStyle(
                                           savedCanvasState.fontStyle
                                         );
                                       if (savedCanvasState.currentFontFamily)
                                         canvasState.setCurrentFontFamily(
                                           savedCanvasState.currentFontFamily
                                         );
                                       if (savedCanvasState.lineOverrides)
                                         canvasState.setLineOverrides(
                                           savedCanvasState.lineOverrides
                                         );
                                       if (
                                         savedCanvasState.titleColorOverride !==
                                         undefined
                                       )
                                         canvasState.setTitleColorOverride(
                                           savedCanvasState.titleColorOverride
                                         );
                                       if (
                                         savedCanvasState.authorColorOverride !==
                                         undefined
                                       )
                                         canvasState.setAuthorColorOverride(
                                           savedCanvasState.authorColorOverride
                                         );
                                       if (
                                         savedCanvasState.isOptimizationEnabled !==
                                         undefined
                                       )
                                         canvasState.setIsOptimizationEnabled(
                                           savedCanvasState.isOptimizationEnabled
                                         );
                                       if (savedCanvasState.skewX !== undefined)
                                         canvasState.setSkewX(
                                           savedCanvasState.skewX
                                         );
                                       if (savedCanvasState.skewY !== undefined)
                                 ...
                                 const [previewState, setPreviewState] =
                                   useState("normal"); // 'normal' | 'dimmed' | 'preview'
                                 const [previewImage, setPreviewImage] =
                                   useState(null);

                                 // State for XY focus callback
                                 const [onXyFocusRequest, setOnXyFocusRequest] =
                                   useState(null);
                                 ...
                                 const [
                                   backgroundLoadingFreeze,
                                   setBackgroundLoadingFreeze,
                                 ] = useState(false);
                                 ...
                                 const [layoutPosition, setLayoutPosition] =
                                   useState("standard");

                                 const handleToggleLayoutPosition =
                                   useCallback(() => {
                                 ...
                                 // Default Mobile Background Strategy
                                 useEffect(() => {
                                   if (
                                     isMobile &&
                                     !canvasState.backgroundImage
                                     ...
                                     const mobileDefault = {
                                       url: "https://images.pexels.com/photos/2268728/pexels-photo-2268728.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=2520&w=2000",
                                       thumbnail:
                                         "https://images.pexels.com/photos/2268728/pexels-photo-2268728.jpeg?auto=compress&cs=tinysrgb&w=200",
                                       alt: "Venster op roze muur",
                                 ...
                                 }, [isMobile, canvasState.backgroundImage]);

                                 // Expose PixiJS app for DevTools
                                 useEffect(() => {
                                   if (canvasState.viewportRef.current?.app) {
                                     window.__PIXI_APP__ =
                                       canvasState.viewportRef.current.app;
                                   }
                                   return () => {
                                 ...
                                 const handleSetImageQualityMode = useCallback(
                                   (mode) => {
                                 ...
                                 const handleCycleQuality = useCallback(() => {
                                   const modes = [
                                     IMAGE_QUALITY_MODE.ECO,
                                     IMAGE_QUALITY_MODE.AUTO,
                                   ...
                                   const nextIndex =
                                     (validCurrentIndex + 1) % modes.length;

                                   handleSetImageQualityMode(modes[nextIndex]);
                                 }, [
                                   canvasState.imageQualityMode,
                                   handleSetImageQualityMode,
                                 ]);
                                 ...
                                 const keyboardShortcuts = useKeyboardShortcuts(
                                   {
                                     ...
                                     setXySlidersVisible:
                                       canvasState.setXySlidersVisible,
                                     highlightVisible:
                                       canvasState.highlightVisible,
                                     setHighlightVisible:
                                       canvasState.setHighlightVisible,
                                     setHoverFreezeActive,
                                     setActiveShortcut,
                                     onToggleLayoutPosition:
                                       handleToggleLayoutPosition,
                                     onToggleUIVisibility:
                                       handleToggleUIVisibility,
                                 ...
                                 const handleMobileCycle = useCallback(() => {
                                   // Cycle: Nav Open (Start) -> Controls Open -> Both Closed -> Loop
                                   if (
                                     layout.navVisible &&
                                     !layout.controlsVisible
                                   ) {
                                     // State 1: Nav -> Controls
                                     layout.toggleNav(); // Close Nav
                                     layout.toggleControls(); // Open Controls
                                   } else if (
                                     !layout.navVisible &&
                                     layout.controlsVisible
                                   ) {
                                     // State 2: Controls -> Nothing
                                     layout.toggleControls(); // Close Controls
                                   } else {
                                     // State 3 / Initial Catch-all: -> Nav only
                                     if (layout.controlsVisible)
                                       layout.toggleControls(); // Ensure controls closed
                                     if (!layout.navVisible) layout.toggleNav(); // Ensure nav open
                                   }
                                 }, [layout]);
                                 ...
                                 const handlers = useMemo(() => {
                                   return {
                                     ...
                                     onToggleNav: layout.toggleNav,
                                     onCycleQuality: handleCycleQuality,
                                     onMobileCycle: handleMobileCycle, // Add to handlers
                                   };
                                 }, [
                                   canvasHandlers,
                                   handleToggleLayoutPosition,
                                 ...
                                 const photosToShow = isFlickrActive
                                   ? canvasState.flickrPhotos
                                   : canvasState.photos;
                                 const isLoading =
                                   canvasState.isFlickrLoading ||
                                 ...
                                 const error =
                                   canvasState.flickrError || canvasState.error;
                                 const hasNextPage = isFlickrActive
                                   ? canvasState.hasNextFlickrPage
                                   : canvasState.hasNextPage;
                                 const hasPrevPage = isFlickrActive
                                   ? canvasState.hasPrevFlickrPage
                                   : canvasState.hasPrevPage;
                                 ...
                                 const handleResetViewport = useCallback(() => {
                                   const viewport =
                                     canvasState.viewportRef.current;
                                   if (viewport) {
                                     viewport.animate({
                                       position: {
                                 ...
                                 useEffect(() => {
                                   debugManager.registerResetHandler(
                                     handleResetViewport
                                   );
                                   return () =>
                                     debugManager.registerResetHandler(null);
                                 }, [handleResetViewport]);
                                 ...
                                 useEffect(() => {
                                   ...
                                   if (
                                     canvasState.moveMode === "line" &&
                                     canvasState.selectedLines.size === 0
                                   ) {
                                     const previousSelection =
                                       keyboardShortcuts.restorePreviousSelection();
                                     if (previousSelection.size > 0) {
                                       canvasState.restoreSelection(
                                         previousSelection
                                       );
                                     }
                                   }
                                 }, [
                                   canvasState.moveMode,
                                   canvasState.selectedLines.size,
                                   keyboardShortcuts,
                                   canvasState.restoreSelection,
                                 ]);
                                 ...
                                 return (
                                   <>
                                     <ResponsiveLayout
                                       ...
                                       onMobileCycle={handleMobileCycle} // Pass cycle handler
                                       controls={
                                         <Controls
                                           qualityOverlay={
                                           ...
                                           onLineHeightChange={
                                             handlers.handleLineHeightChange
                                           }
                                           lineHeightMultiplier={
                                             canvasState.lineHeightMultiplier
                                           }
                                           ...
                                           selectedLines={
                                             canvasState.selectedLines
                                           }
                                           onLineColorChange={
                                             handlers.handleLineColorChange
                                           }
                                           onLineLetterSpacingChange={
                                             handlers.handleLineLetterSpacingChange
                                           }
                                           onLineFontSizeChange={
                                             handlers.handleLineFontSizeChange
                                           }
                                           handleResetSelectedLines={
                                             handlers.handleResetSelectedLines
                                           }
                                           onApplyGlobalLetterSpacing={
                                             handlers.handleApplyGlobalLetterSpacing
                                           }
                                           lineOverrides={
                                             canvasState.lineOverrides
                                           }
                                           viewportDragEnabled={
                                             canvasState.viewportDragEnabled
                                           }
                                           onViewportToggle={
                                             handlers.handleViewportToggle
                                           }
                                           onColorPickerActiveChange={
                                             handlers.handleColorPickerActiveChange
                                           }
                                           effectiveTitleColor={
                                             canvasState.effectiveTitleColor
                                           }
                                           effectiveAuthorColor={
                                             canvasState.effectiveAuthorColor
                                           }
                                           hasTitleColorOverride={
                                             canvasState.hasTitleColorOverride
                                           }
                                           hasAuthorColorOverride={
                                             canvasState.hasAuthorColorOverride
                                           }
                                           onTitleColorChange={
                                             handlers.handleTitleColorChange
                                           }
                                           onAuthorColorChange={
                                             handlers.handleAuthorColorChange
                                           }
                                           onResetTitleColor={
                                             handlers.handleResetTitleColor
                                           }
                                           ...
                                           onFontWeightChange={
                                             handlers.handleFontWeightChange
                                           }
                                           fontStyle={canvasState.fontStyle}
                                           onFontStyleChange={
                                             handlers.handleFontStyleChange
                                           }
                                           skewX={canvasState.skewX}
                                           onSkewXChange={
                                             handlers.handleSkewXChange
                                           }
                                           onLineSkewXChange={
                                             handlers.handleLineSkewXChange
                                           }
                                           ...
                                           onResetToCollection={
                                             handlers.handleResetToCollection
                                           }
                                           onOpenPhotoGrid={
                                             handlers.handleOpenPhotoGrid
                                           }
                                           ...
                                           isOptimizationEnabled={
                                             canvasState.isOptimizationEnabled
                                           }
                                           ...
                                           textMaterial={
                                             canvasState.textMaterial
                                           }
                                           onTextMaterialChange={
                                             canvasState.setTextMaterial
                                           }
                                           textPadding={canvasState.textPadding}
                                           onTextPaddingChange={
                                             canvasState.setTextPadding
                                           }
                                           textEffectMode={
                                             canvasState.textEffectMode
                                           }
                                           setTextEffectMode={
                                             canvasState.setTextEffectMode
                                           }
                                           textEffectParams={
                                             canvasState.textEffectParams
                                           }
                                           setTextEffectParams={
                                             canvasState.setTextEffectParams
                                           }
                                           imageQualityMode={
                                             canvasState.imageQualityMode
                                           }
                                         ...
                                         >
                                           ...
                                           >
                                             <CanvasContent
                                               ...
                                               contentRef={
                                                 canvasState.contentRef
                                               }
                                               appRef={canvasState.appRef}
                                               fontFamily={
                                                 canvasState.fontFamily
                                               }
                                               fontStatus={
                                                 canvasState.fontStatus
                                               }
                                               fontWeight={
                                                 canvasState.fontWeight
                                               }
                                               fontStyle={canvasState.fontStyle}
                                               skewX={canvasState.skewX}
                                               skewY={canvasState.skewY}
                                               ...
                                               onLineSelect={
                                                 handlers.handleLineSelect
                                               }
                                               viewportDragEnabled={
                                                 canvasState.viewportDragEnabled
                                               }
                                               isColorPickerActive={
                                                 canvasState.isColorPickerActive
                                               }
                                               backgroundImage={
                                                 previewImage ||
                                                 canvasState.backgroundImage
                                               ...
                                               setIsDragging={
                                                 canvasState.setIsDragging
                                               }
                                               effectiveStyles={
                                                 canvasState.effectiveStyles
                                               }
                                               highlightVisible={
                                                 canvasState.highlightVisible
                                               }
                                       ...
                                       navigation={
                                         <Navigation
                                           onSyncAllColorsToGlobal={
                                             handlers.handleSyncAllColorsToGlobal
                                           }
                                           onSyncAllFontsToGlobal={
                                             handlers.handleSyncAllFontsToGlobal
                                           }
                                           moveMode={canvasState.moveMode}
                                           setMoveMode={canvasState.setMoveMode}
                                           selectedLines={
                                     ...
                                     {canvasState.photoGridVisible && (
                                       <FloatingPhotoGrid
                                         ...
                                         onClose={() =>
                                           canvasState.setPhotoGridVisible(
                                             false
                                           )
                                         }
