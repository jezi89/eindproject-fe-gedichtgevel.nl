  ...
  return (
    <div className="page-faq">
      ...
      <section className="faq-section">
        <h2>Hoe werkt het?</h2>
        <p>Hier vind je uitleg over het gebruik van GedichtGevel.</p>
      </section>

      <section className="faq-section">
        <h2>Gedichten zoeken</h2>
        <p>
          Gebruik de zoekbalk om gedichten te vinden op titel, dichter of
          trefwoord.
        </p>
      </section>
      ...
      <section className="faq-section">
        ...
        <p>
          In de Designgevel kun je gedichten op een gevel plaatsen en vormgeven.
        </p>
      </section>

      <section className="faq-section">
        <h2>Audio opnemen</h2>
        <p>Met de Spreekgevel kun je gedichten inspreken en beluisteren.</p>
      </section>
    </div>
  );
}
