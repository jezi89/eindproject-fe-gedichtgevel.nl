    ...
    try {
        const serialized = {
            ...
            perspective: {
                ...
                freeMode: canvasState.perspFreeMode ?? false,
                corners: canvasState.perspCorners ?? null
            },
        ...
        if (jsonString.length > 1024 * 1024) { // 1MB limit
            console.warn('Canvas state exceeds 1MB limit');
        }
...
export function deserializeCanvasState(designSettings) {
    try {
        ...
        const canvasState = {
            ...
            perspFreeMode: designSettings.perspective?.freeMode ?? false,
            perspCorners: designSettings.perspective?.corners ?? null,
